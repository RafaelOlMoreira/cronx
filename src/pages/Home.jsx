...
function Home() {
    return (
        <section className='relative min-h-screen' id='#Home'>
            ...
            <div id='Home' className='relative h-screen flex flex-col justify-center mx-5 lg:mx-15 space-y-5 lg:w-2/5'>
                ...
                <div className='space-y-4 lg:space-y-0 lg:flex lg:gap-x-5'>
                    <a href="#Contact" className='block text-center text-nowrap bg-white p-4 text-xl w-full rounded-lg hover:cursor-pointer transition duration-300 hover:scale-105'>
